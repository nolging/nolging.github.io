-- =============================================================
--  미니게임 통합 스키마 (tarot / puzzle / praise stickers)
--  이 파일은 예전에 아래 7개의 개별 파일로 나뉘어 있던 SQL 을 하나로 합친 것입니다.
...
--  예외: praise_place() 하나는 위 7개 파일이 아니라 notif-strict-templates-2.sql(알림
...
--
--  ⚠️ 이미 운영 중인(live) 프로덕션 DB에는 원본 7개 파일이 각각 순서대로 이미 적용되어
