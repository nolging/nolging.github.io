...
// (기준점 17.91,8.74 를 고정하고 나머지 점을 그 점 기준 2배로 늘림).
const DEVIL_HORN_D = 'M17.91 8.74 C21.63 10.46 24.21 9.4 25.65 5.56 L18.53 -0.72 Z'
...
const SPLIT_ANCHOR = {
  ...
  'deco-devil-horn': { l: [21.78, 4.87], r: [78.22, 4.87] },
