...
// 위로 올라온 부분만 보여 "후드 뒤에서 솟는" 느낌을 준다. 프로필 사진 폭 전체(x 0~100)에
// 걸쳐 자리·크기·색·타이밍을 조금씩 달리 흩어 놓아 한 곳에 몰리지 않고, 한꺼번에 튀지도
// 않고 "간간이" 따로따로 둥실 떠오르는 것처럼 보이게 한다.
const HOOD_HEARTS = [
  { x: 10, y: -5, s: 0.72, d: 0, dur: 5.2, c: '#ff2d55' },
  { x: 26, y: -9, s: 0.58, d: 1.1, dur: 4.7, c: '#ff7a9c' },
  { x: 42, y: -4, s: 0.66, d: 2.2, dur: 5.6, c: '#ff4d6d' },
  { x: 58, y: -8, s: 0.78, d: 0.5, dur: 5, c: '#ffb3c6' },
  { x: 73, y: -3, s: 0.6, d: 3, dur: 4.4, c: '#e0245e' },
  { x: 88, y: -7, s: 0.68, d: 1.8, dur: 5.4, c: '#ff5d7a' },
]
