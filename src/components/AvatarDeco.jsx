...
// 순수 벡터 path(PNG 아님) — 이등변 부채꼴: 뾰족한 끝(18.22,4.01)에서 뻗은 두 변의 길이가
// 같은 직선이고, 밑변만 아래로 살짝 볼록한 호. 기존의 살짝 기운 각도는 그대로 유지.
const DEVIL_HORN_D = 'M17.91 8.74 C19.77 9.6 21.06 9.07 21.78 7.15 L18.22 4.01 Z'
