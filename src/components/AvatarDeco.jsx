...
// 순수 벡터 path(PNG 아님) — 바닥 선은 지저분한 잔물결 대신 아래로 살짝 볼록한 호 하나로 마감.
const DEVIL_HORN_D = 'M17.91 8.74 C19.5 10.8 22.3 10.8 23.93 9.05 C23.93 8.62 18.71 4.01 18.22 4.01 C17.99 4.01 17.91 5.47 17.91 8.74 Z'
