...
// 접은 쪽지: 아래 변 없는 네모 몸통 + X, 그 아래 큰 직사각형(기울어짐) + 오른쪽 변 위 작은 직사각형
const NoteIcon = () => tabSvg(<>
  <path d="M5 14 V5 Q5 4 6 4 H18 Q19 4 19 5 V14" />
  <path d="M5.5 5 18.5 14M18.5 5 5.5 14" />
  <path d="M6 14 L13 11.5 L11.5 20.5 L4.5 18 Z" />
  <path d="M13 11.5 L18 13.5 L16.5 17.5 L11.5 15.5 Z" />
</>)
